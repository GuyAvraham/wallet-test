...
export default function getTransactions(account: IAccount) {
    ...
    return fetch(`${domain}/api?module=account&action=txlist&address=${account.account}&startblock=0&endblock=99999999&page=1&offset=10&sort=asc&apikey=${TRANSACTIONS_DATA_KEY}`, {method: 'GET'})
    .then(result => {
